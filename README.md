...
```bash
python3 /Users/${user_name}/.codex/skills/install-agent-skills/scripts/install_agent_skills.py \
...
```bash
python3 /Users/${user_name}/.codex/skills/install-agent-skills/scripts/install_agent_skills.py --list
```
...
```bash
python3 /Users/${user_name}/.codex/skills/link-repo-skills/scripts/link_repo_skills.py \
...
```bash
find /path/to/project/.agents/skills -maxdepth 2 -name SKILL.md -print
```
